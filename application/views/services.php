...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item active"><?php echo $this->lang->line('services'); ?></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="javascript:;" onclick="showAjaxModal('<?php echo base_url('modal/popup/modal_edit_service/' . $row['service_id']); ?>');">
                                                <?php echo $this->lang->line('edit'); ?>
                                                </a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="javascript:;" onclick="confirm_modal('<?php echo base_url('service_settings/remove/' . $row['service_id']); ?>');">
