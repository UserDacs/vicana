                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="javascript:;" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_change_tenant_lease/<?php echo $tenant['tenant_id']; ?>');">
                                                    <?php echo $this->lang->line('lease_period'); ?>
                                                </a>
