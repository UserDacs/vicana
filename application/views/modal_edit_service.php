...
<div class="form-group">
	<label><?php echo $this->lang->line('service_name'); ?> *</label>
	<input value="<?php echo html_escape($this->db->get_where('service', array('service_id' => $param2))->row()->description); ?>" type="text" name="description" placeholder="Description" class="form-control" data-parsley-required="true">
</div>
<div class="form-group">
