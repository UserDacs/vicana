                        ...
                        <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            if ($this->db->get_where('id_type', array('id_type_id' => $less_than_30_lease['id_type_id']))->num_rows() > 0)
                                                echo $this->db->get_where('id_type', array('id_type_id' => $less_than_30_lease['id_type_id']))->row()->name;
                                            else
                                                echo 'ID Type not found';
                                        ?>
                                    </td>
                        ...
                        <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            if ($this->db->get_where('id_type', array('id_type_id' => $less_than_60_lease['id_type_id']))->num_rows() > 0)
                                                echo $this->db->get_where('id_type', array('id_type_id' => $less_than_60_lease['id_type_id']))->row()->name;
                                            else
                                                echo 'ID Type not found';
                                        ?>
                                    </td>
                        ...
                        <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            if ($this->db->get_where('id_type', array('id_type_id' => $less_than_90_lease['id_type_id']))->num_rows() > 0)
                                                echo $this->db->get_where('id_type', array('id_type_id' => $less_than_90_lease['id_type_id']))->row()->name;
                                            else
                                                echo 'ID Type not found';
                                        ?>
                                    </td>
