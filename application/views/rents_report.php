                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                                if ($this->db->get_where('tenant', array('tenant_id' => $tenant_rent['tenant_id']))->num_rows() > 0)
                                                    echo $this->db->get_where('tenant', array('tenant_id' => $tenant_rent['tenant_id']))->row()->name; 
                                                else
                                            ...
                                            <?php
                                                ...
                                                if (sizeof($services) > 0) {
                                                    foreach ($services as $key => $value) {
                                                        if ($this->db->get_where('service', array('service_id' => $value['service_id']))->num_rows() > 0) {
