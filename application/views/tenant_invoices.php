                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        foreach ($service_costs as $service_cost) {
                                            if ($this->db->get_where('service', array('service_id' => $service_cost['service_id']))->num_rows() > 0)
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="javascript:;" onclick="confirm_modal('<?php echo base_url('invoices/remove/' . $row['invoice_id']); ?>');">
                        ...
                        <p>
                            ...
                            foreach ($due_invoices as $due_invoice) {
                                ...
                                foreach ($due_services as $due_service) {
                                    if ($this->db->get_where('service', array('service_id' => $due_service['service_id']))->num_rows() > 0)
                        ...
                        <p>
                            ...
                            foreach ($total_invoices as $total_invoice) {
                                ...
                                foreach ($total_services as $total_service) {
                                    if ($this->db->get_where('service', array('service_id' => $total_service['service_id']))->num_rows() > 0)
